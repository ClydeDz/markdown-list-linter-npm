...
describe('lintMarkdownList()', () => {
  describe('given a valid file is tested', () => {
    describe.each([Files.SimpleLists.ValidFile, Files.LinkedLists.ValidFile])(
      'given file %s is passed',
      (markdownFile: string) => {
  ...
  describe('given unordered lists are tested', () => {
    const correctOrderForSimpleList = [
      ['African Buffalo', 'Aardwolf'],
      ['Chameleon', 'Camel', 'Cheetah', 'Canary'],
    ]
    ...
    describe.each([
      [
        Files.SimpleLists.UnorderedLists,
        correctOrderForSimpleList,
        correctFormattedMessageForSimpleList,
      ],
      [
        Files.LinkedLists.UnorderedLists,
        correctOrderForLinkedList,
        correctFormattedMessageForLinkedList,
      ],
    ])(
      'given file %s is passed',
      (
  ...
  describe('given unordered headings and lists are tested', () => {
    ...
    const correctListOrderForSimpleList = [
      ['African Buffalo', 'Aardwolf'],
      ['Chameleon', 'Camel', 'Cheetah', 'Canary'],
    ]
    ...
    describe.each([
      [
        Files.SimpleLists.UnorderedListsAndHeadings,
        correctHeadingsOrder,
        correctListOrderForSimpleList,
        correctFormattedMessageForSimpleList,
      ],
      [
        Files.LinkedLists.UnorderedListsAndHeadings,
        correctHeadingsOrder,
        correctListOrderForLinkedList,
        correctFormattedMessageForLinkedList,
      ],
    ])(
      'given file %s is passed',
      (
        markdownFile: string,
        correctHeadingsOrder: string[][],
        correctListOrder: string[][],
        expectedFormattedMessage: string[]
      ) => {
        it('should return with errors', () => {
          const expected = {
